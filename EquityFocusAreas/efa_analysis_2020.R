#' The following script is used to EXPLORE various compinations of how the new EFA's
#' should be calculated for 2020. The final iteration of the 2020 EFAs is calculated
#' in efa_current_2020.
#' 
#'  
...
#st_write(efaPerc2020shp, dsn = "results/EFAs_2020.gpkg",layer = "EquityFocusAreasPerc2020",append=TRUE)
#st_write(efaSD2020shp, dsn = "results/EFAs_2020.gpkg", layer = "EquityFocusAreasSD2020", append=TRUE) 
...
#st_write(efaPerc2020Pov25NoCarshp, dsn = "results/EFAs_2020_2.gpkg", layer = "EFAs2020Pov25NoCar",append=TRUE)
#st_write(efaPerc2020Pov20NoCarshp, dsn = "results/EquityFocusAreas2020v2.gpkg", layer = "EFAs2020Pov20Min40NoCar",append=TRUE)
#st_write(efaPerc2020Pov20Carshp, dsn = "results/EFAs_2020_2.gpkg", layer = "EFAs2020Pov20Car",append=TRUE)
#st_write(efaPerc2017Pov25NoCarshp, dsn = "results/EFAs_2017_2.gpkg", layer = "EFA2017Pov25NoCar",append=TRUE)
#st_write(efaPerc2017Pov20NoCarshp, dsn = "results/EFAs_2017_2.gpkg", layer = "EFA2017Pov20NoCar",append=TRUE)
...
#st_write(efa2020FinalZones, dsn = "results/shps/EquityFocusAreas2020v4/EquityFocusAreas2020v4.shp", layer = "EFA2020Pov20Min40NoCar",append=TRUE)
...
#geojsonio::geojson_write(efa2020final_json,file = "results/efa2020.geojson")
